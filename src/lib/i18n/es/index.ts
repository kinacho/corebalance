...
const es = {
  ...
  db: {
    ...
    drift_subtitle: 'A qué distancia de su objetivo ha estado cada activo, día a día',
    ...
    drift_band_legend: 'Banda ±{pp:number} pp',
    ...
    composition_legend_band: 'Banda de tolerancia ±{pp:number} pp',
