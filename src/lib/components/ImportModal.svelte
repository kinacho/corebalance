...
<style>
	...
	.category-picker select { background:rgba(0,0,0,.3); border:1px solid rgba(255,255,255,.1); border-radius:8px; color:var(--text-primary); padding:.3rem .5rem; font-size:.7rem; font-weight:600; outline:none; cursor:pointer; }
	...
	.manual-ticker-edit { padding: 0.5rem 0.75rem 0.75rem; background: rgba(0, 0, 0, 0.1); border-radius: 0 0 12px 12px; margin-top: -4px; border: 1px solid var(--border-subtle); border-top: none; }
