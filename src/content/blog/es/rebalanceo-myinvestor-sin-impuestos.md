...
> [!IMPORTANT]
> Los **ETFs (fondos cotizados)** no disfrutan de esta exención en España. Si rebalanceas vendiendo un ETF para comprar otro, tendrás que tributar entre el 19% y el 28% por las plusvalías generadas. Por eso, para carteras basadas en fondos de inversión tradicionales en plataformas como MyInvestor, el traspaso es la herramienta reina.
...
2. **Introduce tus fondos y objetivos en CoreBalance:**
   Crea tu cartera en CoreBalance indicando tus fondos indexados, sus códigos ISIN (opcional) y el peso objetivo de cada uno (por ejemplo, 80% acciones y 20% bonos).
3. **Introduce tus saldos reales:**
   Escribe el valor actual de cada fondo obtenido en el paso 1. La aplicación te mostrará visualmente y en tiempo real el desvío exacto.
4. **Calcula el rebalanceo:**
...
1. **Inicia sesión** en la web o aplicación móvil de MyInvestor.
2. Ve a la sección de **Inversiones > Fondos de inversión**.
3. Busca el fondo de origen (el que está sobreponderado y del que quieres sacar dinero) dentro de tus posiciones y haz clic en **Operar**.
4. Selecciona la opción **Traspasar** (¡Cuidado! No elijas *Vender*, ya que eso activará la retención fiscal de Hacienda).
