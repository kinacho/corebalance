...
### Controla tus desviaciones con CoreBalance

Para saber si tu cartera necesita un reajuste sin perder tiempo calculando porcentajes a mano, puedes usar **CoreBalance**.

Nuestra calculadora gratuita e interactiva analiza de forma visual el nivel de desviación exacto de cada uno de tus activos. Si decides rebalancear, te indicará al céntimo si puedes hacerlo simplemente dirigiendo tu flujo de ahorro mensual a los activos rezagados (evitando vender nada) o si necesitas ordenar un traspaso de fondos indexados libre de impuestos. Todo con absoluta privacidad local en tu dispositivo.
