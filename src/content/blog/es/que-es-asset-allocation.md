...
1. **Renta Variable (Acciones):** Representa la compra de pequeñas partes de empresas. Ofrece el mayor potencial de crecimiento a largo plazo, pero a cambio de una alta volatilidad (subidas y bajadas bruscas de precio).
2. **Renta Fija (Bonos):** Préstamos que haces a gobiernos o empresas a cambio de un tipo de interés predecible. Su rentabilidad histórica es menor que la de las acciones, pero su precio es mucho más estable y actúa como amortiguador en momentos de crisis.
3. **Efectivo (Dinero líquido o depósitos):** La opción más segura y líquida, pero que pierde poder adquisitivo año tras año debido a la inflación.
4. **Activos Reales (Oro, materias primas o inmobiliario):** Activos tangibles que suelen actuar como refugio contra la inflación o crisis sistémicas (especialmente el oro).
...
1. La selección de valores individuales (comprar unas acciones u otras).
2. El *market timing* (intentar predecir cuándo comprar o vender).
3. **El Asset Allocation (la estrategia de asignación de activos).**
...
> [!IMPORTANT]
> Rebalancear de forma regular consiste en vender una parte de los activos ganadores para comprar los activos rezagados. Es la única forma de asegurar que tu cartera sigue reflejando el nivel de riesgo que decidiste asumir en un principio.
