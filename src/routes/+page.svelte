  ...
  <main class="main-content">
    ...
    <footer class="app-footer">
      ...
      <div class="footer-copyright">
        <p>© {new Date().getFullYear()} CoreBalance · Hecho con ❤️ para la comunidad inversora · <button class="changelog-badge-btn" onclick={() => showChangelog = true} title="Ver historial de cambios">v1.2.0-beta 🚀</button></p>
      </div>
    </footer>
  </main>
</div>
